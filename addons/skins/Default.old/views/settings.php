...
<li id='headerColor'>
<label>页头颜色</label>
<?php echo $form->input("headerColor", "text", array("class" => "color")); ?> <a href='#' class='reset'>重置</a>
</li>


<li id='bodyColor'>
<label>背影颜色</label>
<?php echo $form->input("bodyColor", "text", array("class" => "color")); ?> <a href='#' class='reset'>重置</a>
</li>
...
<label class='checkbox'><?php echo $form->checkbox("bodyImage"); ?>使用背景图片</label>
<div class='indent'>
